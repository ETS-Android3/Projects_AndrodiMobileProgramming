...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // indichiamo il path del file da riprodurre
        vv.setVideoURI(Uri.parse("android.resource://it.unisa.di.mp.widgets/raw/muppet"));

        // creiamo un mediacontroller cosi l'utente potrà controllare il video
         ...
         */
        // otteniamo l'array di stringhe dalle risorse, definito in string.xml
        final String[] lista_nazioni = getResources().getStringArray(R.array.nazioni);

        // creiamo un autocompleteview. Dobbiamo specificare l'adapter passando la lista di stringhe che suggerirà
